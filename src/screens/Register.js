	...
	render(){
		return(
			<div style={{height:"100%", paddingBottom:160,backgroundImage: "url(http://3.bp.blogspot.com/-OlHVbclWofM/WUHHAo9cZeI/AAAAAAAAGCI/xx9R8nVEnlIOe16iHvUXfsRseYTdgYp5ACHMYBhgL/s1600/tmc18-anime-background-wallpaper-anime-images-in-high-quality.jpg)"}} >
              ...
              <input type="password" className="form-control" name="password" placeholder="Confirm Password"/>	<br/>
              <input  className="form-control" name="email" placeholder="Email"/>	<br/>
							<a style={{backgroundColor:'#CA0504'}} className="btn btn-danger btn-block">SIGN UP</a>
				</div>
			</div>
			);
	}	 
